...
create table countries(country_id varchar(30) primary key, country_name varchar(30), region_id int not null, foreign key(region_id) references regions(region_id));
create table locations(location_id int primary key, street_address varchar(30), postal_code varchar(30), city varchar(30), state_province varchar(30), country_id varchar(30) not null, foreign key(country_id) references countries(country_id));
